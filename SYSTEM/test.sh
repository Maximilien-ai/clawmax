...
if grep -q "PluginWorkspaceLayout.test.ts: 69 tests passed" /tmp/clawmax-plugin-workspace-layout.out; then
  pass "Plugin workspace layout regression tests (69 tests)"
else
