...
if grep -q "PluginWorkspaceLayout.test.ts: 56 tests passed" /tmp/clawmax-plugin-workspace-layout.out; then
  pass "Plugin workspace layout regression tests (56 tests)"
else
