...
for workflow_suite in server/routes/dev-template-workflow.test.ts server/routes/dev-workflow-summary.test.ts server/lib/workflow-brief.test.ts server/lib/dev-workflow-settings.test.ts server/lib/brief-delivery.test.ts client/src/lib/devWorkflowResponse.test.ts; do
