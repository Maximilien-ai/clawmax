...
for template_suite in server/lib/portable-template-zip.test.ts server/lib/portable-template.test.ts server/routes/instance-templates.test.ts server/lib/messages-workspace-isolation.test.ts server/lib/workspace-file-transaction.test.ts server/lib/template-revisions.test.ts; do
