...
- Branch: `main`
- Current test candidate: `2.0.0-test-rc16`, focused on explainable automatic model suggestions during agent creation and editing, Quality/Balanced/Cost priorities, explicit apply-and-save behavior, runtime-supported alternatives, and mobile/restart smoke checks. Unconfirmed RC15 and earlier checks remain in the cumulative 2.0 Review set.
