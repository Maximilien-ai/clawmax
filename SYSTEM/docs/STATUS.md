...
**Status**: `v1.7.3` is the current release candidate line on `main`

---

## Current State

- `main` now carries the `1.7.3` release candidate line, the next follow-through release on top of upgraded OpenClaw `2026.5.26`
...
- partner integrations and partner-backed skills are now part of the active stabilization line, including `Resend`, partner tabs, partner skill grouping, and one-click catalog import flows
