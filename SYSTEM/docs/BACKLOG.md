...
- [ ] **1.9.4 OpenClaw update track** — once `1.9.3` stabilizes the archive/resume surfaces, take the planned OpenClaw update with the stronger wrapper/coverage baseline already established in `1.9.1` and extended in `1.9.2`/`1.9.3`.
