...
- [ ] **1.8.x hardening + simplification follow-through** — `1.8.0` through `1.8.7` now cover the first stability, responsiveness, Add Agent, delete-flow, DocHub, notification, workflow session, and model lifecycle cleanup slices, and `1.8.8-test-rc1` is validating the next template/workflow hardening pass. Continue from [HARDENING_SIMPLIFICATION_1_8_X.md](/Users/maximilien/github/Maximilien-ai/clawmax-codex/SYSTEM/docs/planning/HARDENING_SIMPLIFICATION_1_8_X.md), [SIMPLIFY_OPTIMIZE_1_8_X.md](/Users/maximilien/github/Maximilien-ai/clawmax-codex/SYSTEM/docs/planning/SIMPLIFY_OPTIMIZE_1_8_X.md), and the active [SIMPLIFY_HARDEN_OPTIMIZE_1_8_8.md](/Users/maximilien/github/Maximilien-ai/clawmax-codex/SYSTEM/docs/planning/SIMPLIFY_HARDEN_OPTIMIZE_1_8_8.md) closure sprint.
