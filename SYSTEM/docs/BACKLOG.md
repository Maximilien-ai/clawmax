...
- [ ] **Plugin architecture MVP1 follow-through** — the first generic declarative v2 host contract and operator health diagnostics are merged. Continue with host-mediated actions and permissions, external packaging validation, plugin page/data loading speed, DocHub/file-open polish, and shared UI parity with Agents/Workflows.
