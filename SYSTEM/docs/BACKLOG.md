...
- [ ] **1.9.0 hardening + simplification follow-through** — `1.8.0` through `1.8.9` now cover the first stability, responsiveness, Add Agent, delete-flow, DocHub, notification, workflow session, model lifecycle, template/workflow audit cleanup, and chat/runtime recovery slices. Continue from [HARDENING_SIMPLIFICATION_1_8_X.md](/Users/maximilien/github/Maximilien-ai/clawmax-codex/SYSTEM/docs/planning/HARDENING_SIMPLIFICATION_1_8_X.md), [SIMPLIFY_OPTIMIZE_1_8_X.md](/Users/maximilien/github/Maximilien-ai/clawmax-codex/SYSTEM/docs/planning/SIMPLIFY_OPTIMIZE_1_8_X.md), and [SIMPLIFY_HARDEN_OPTIMIZE_1_9_0.md](/Users/maximilien/github/Maximilien-ai/clawmax-codex/SYSTEM/docs/planning/SIMPLIFY_HARDEN_OPTIMIZE_1_9_0.md) for the remaining provider/runtime, workflow/channel, DocHub/file-open, metering, and operator-recovery follow-through.
