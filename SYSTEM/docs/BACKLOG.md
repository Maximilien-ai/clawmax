...
- [ ] **1.8.x hardening + simplification follow-through** — `1.8.0` through `1.8.8` now cover the first stability, responsiveness, Add Agent, delete-flow, DocHub, notification, workflow session, model lifecycle, and template/workflow audit cleanup slices. Continue from [HARDENING_SIMPLIFICATION_1_8_X.md](/Users/maximilien/github/Maximilien-ai/clawmax-codex/SYSTEM/docs/planning/HARDENING_SIMPLIFICATION_1_8_X.md), [SIMPLIFY_OPTIMIZE_1_8_X.md](/Users/maximilien/github/Maximilien-ai/clawmax-codex/SYSTEM/docs/planning/SIMPLIFY_OPTIMIZE_1_8_X.md), and [SIMPLIFY_HARDEN_OPTIMIZE_1_8_9.md](/Users/maximilien/github/Maximilien-ai/clawmax-codex/SYSTEM/docs/planning/SIMPLIFY_HARDEN_OPTIMIZE_1_8_9.md) for the current auth/runtime hardening slice, chat/runtime stability fixes, workflow-failure deep links, workspace-switch notification cleanup, and remaining closure work.
