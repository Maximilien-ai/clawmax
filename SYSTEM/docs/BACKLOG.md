...
- [ ] **1.9.2 diagnostics + cleanup follow-through** — `1.9.1` is now promoted as the stabilization release. Continue from [HARDENING_SIMPLIFICATION_1_8_X.md](/Users/maximilien/github/Maximilien-ai/clawmax-codex/SYSTEM/docs/planning/HARDENING_SIMPLIFICATION_1_8_X.md), [SIMPLIFY_OPTIMIZE_1_8_X.md](/Users/maximilien/github/Maximilien-ai/clawmax-codex/SYSTEM/docs/planning/SIMPLIFY_OPTIMIZE_1_8_X.md), [archive/SIMPLIFY_HARDEN_OPTIMIZE_1_9_1.md](/Users/maximilien/github/Maximilien-ai/clawmax-codex/SYSTEM/docs/planning/archive/SIMPLIFY_HARDEN_OPTIMIZE_1_9_1.md), and [SIMPLIFY_HARDEN_OPTIMIZE_1_9_2.md](/Users/maximilien/github/Maximilien-ai/clawmax-codex/SYSTEM/docs/planning/SIMPLIFY_HARDEN_OPTIMIZE_1_9_2.md) for the remaining operator diagnostics cleanup, DocHub/file-open closure, workflow/thread follow-through, selective `Maximilien-ai/templates` / `Maximilien-ai/workflows` sync, metering/workspace-state accuracy, and measured coverage follow-through.
- [ ] **1.9.3 chat archives cleanup track** — prepare the next release around `#158` and `#159`: broken archive list metadata/timestamps/title parsing plus archived conversation restore/resume. Use [SIMPLIFY_HARDEN_OPTIMIZE_1_9_3.md](/Users/maximilien/github/Maximilien-ai/clawmax-codex/SYSTEM/docs/planning/SIMPLIFY_HARDEN_OPTIMIZE_1_9_3.md) as the focused archive/resume scope once `1.9.2` validation is complete.
