...
- [ ] **2.0 security release-artifact appendix** — the source audit, threat model, 29-family authorization matrix, dynamic boundary tests, findings register, SBOM/license inventory, dependency/secret scans, Medium-risk decisions, RC43 public digest, and private combined-image acceptance are recorded. There are no unresolved Critical/High findings. Before promotion, append cloud/on-prem runtime evidence and the Review approver to [SECURITY_REVIEW_2_0_RC38.md](security/SECURITY_REVIEW_2_0_RC38.md).
