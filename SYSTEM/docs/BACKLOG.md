...
- [ ] **1.9.3 chat archives cleanup track** — `1.9.2` is now promoted. Continue the next release around `#158` and `#159`: broken archive list metadata/timestamps/title parsing plus archived conversation restore/resume. Use [SIMPLIFY_HARDEN_OPTIMIZE_1_9_3.md](/Users/maximilien/github/Maximilien-ai/clawmax-codex/SYSTEM/docs/planning/SIMPLIFY_HARDEN_OPTIMIZE_1_9_3.md) as the focused archive/resume scope.
