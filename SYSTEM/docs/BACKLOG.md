...
- [ ] **1.9.8 tester-feedback track** — collect reproducible `1.9.7` feedback from Mike and other testers, record environment/image/model details, and prioritize narrow fixes for chat, group chat, workflows, plugins, model diagnostics, and container deployments. Active plan: [SIMPLIFY_HARDEN_OPTIMIZE_1_9_8.md](/Users/maximilien/github/Maximilien-ai/clawmax-codex/SYSTEM/docs/planning/SIMPLIFY_HARDEN_OPTIMIZE_1_9_8.md).
