...
- [ ] **1.9.1 diagnostics + public sync follow-through** — `1.9.0` closed the high-signal workflow/thread/archive/operator hardening pass. Continue from [HARDENING_SIMPLIFICATION_1_8_X.md](/Users/maximilien/github/Maximilien-ai/clawmax-codex/SYSTEM/docs/planning/HARDENING_SIMPLIFICATION_1_8_X.md), [SIMPLIFY_OPTIMIZE_1_8_X.md](/Users/maximilien/github/Maximilien-ai/clawmax-codex/SYSTEM/docs/planning/SIMPLIFY_OPTIMIZE_1_8_X.md), and [SIMPLIFY_HARDEN_OPTIMIZE_1_9_1.md](/Users/maximilien/github/Maximilien-ai/clawmax-codex/SYSTEM/docs/planning/SIMPLIFY_HARDEN_OPTIMIZE_1_9_1.md) for the remaining operator diagnostics cleanup, selective `Maximilien-ai/templates` / `Maximilien-ai/workflows` sync, lingering DocHub/file-open edge cases, and non-blocking workflow/thread follow-through.
- [ ] **1.9.2 cleanup line prep** — once `1.9.1-test-rc2` is either promoted or clearly stable, use [SIMPLIFY_HARDEN_OPTIMIZE_1_9_2.md](/Users/maximilien/github/Maximilien-ai/clawmax-codex/SYSTEM/docs/planning/SIMPLIFY_HARDEN_OPTIMIZE_1_9_2.md) as the next release line for diagnostics follow-through, DocHub/file-open closure, workflow/thread cleanup, selective public sync, metering/workspace-state accuracy, and measured coverage follow-through.
