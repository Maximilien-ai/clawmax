...
- [ ] **Cloud/on-prem `1.8.4` release validation** — validate `1.8.4-test-rc1` on real cloud and on-prem deployments, focusing on Add Agent model/default behavior, agent delete flows from cards/detail/bulk operations, and the previous `1.8.2` runtime/notification fixes.
