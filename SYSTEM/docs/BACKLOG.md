...
- [ ] **1.8.x hardening + simplification follow-through** — `1.8.0` through `1.8.7` now cover the first stability, responsiveness, Add Agent, delete-flow, DocHub, notification, workflow session, and model lifecycle cleanup slices. Continue from [HARDENING_SIMPLIFICATION_1_8_X.md](/Users/maximilien/github/Maximilien-ai/clawmax-codex/SYSTEM/docs/planning/HARDENING_SIMPLIFICATION_1_8_X.md) plus the next `1.8.8` planning note and the remaining follow-through below.
