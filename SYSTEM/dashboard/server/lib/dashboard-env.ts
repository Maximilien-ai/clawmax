...
const DASHBOARD_RUNTIME_ENV_KEYS = [
  ...
  'CLAWMAX_MAX_WORKSPACES',
  'CLAWMAX_MAX_AGENTS_PER_WORKSPACE',
  'CLAWMAX_MAX_WORKFLOWS_PER_WORKSPACE',
  'CLAWMAX_RESOURCE_LIMIT_UPGRADE_MESSAGE',
  'CLAWMAX_RESOURCE_LIMIT_UPGRADE_URL',
