...
assert(serverSource.includes('resourceLimitConfig: getTenantResourceLimitConfig(rawEnv)'), 'Public auth config must expose optional generic resource-limit upgrade presentation')
...
console.log('InstanceBranding.test.ts: 13 assertions passed')
