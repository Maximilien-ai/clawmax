...
assert(templates.length === 5, 'Lifecycle must provide five focused agent and workflow inspections')
...
assert(pluginPage.includes("subjectType={selectedItem.fields.subjectType === 'workflow' ? 'workflow' : 'agent'}"), 'Lifecycle X-rays must load both agent and workflow evidence')
...
console.log('PluginLifecycleSkeleton.test.ts: 36 tests passed')
