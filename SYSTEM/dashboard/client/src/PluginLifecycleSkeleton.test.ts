...
assert(pluginPage.includes('(eventIndex / (events.length - 1))'), 'Lifecycle graph must space events for readability instead of compressing them by wall-clock time')
...
console.log('PluginLifecycleSkeleton.test.ts: 33 tests passed')
