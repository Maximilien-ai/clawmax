        ...
        {!loading && !error && suggestedModel && recommendation && (
          <>
            <div className="flex min-w-0 flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
              <div className="min-w-0">
                <div className="break-all font-medium">Suggested model: {suggestedModel}</div>
              ...
              {onUseSuggestion && (
                <button
                  ...
                  className="shrink-0 rounded-md bg-sky-600 px-3 py-1.5 text-xs font-medium text-white hover:bg-sky-700 disabled:cursor-default disabled:bg-green-600"
                >
                ...
                <div className="mt-1 flex flex-wrap gap-1.5">
                  {recommendation.candidates.slice(1).map(candidate => (
                    <button
                      key={candidate.model}
                      type="button"
                      disabled={!onUseSuggestion || candidate.model === selectedModel}
