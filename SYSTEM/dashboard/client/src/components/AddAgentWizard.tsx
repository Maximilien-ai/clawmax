          ...
          {step === 1 && (
            <div className="space-y-4">
              ...
              <div className="rounded-lg border border-sky-200 dark:border-sky-800 bg-sky-50 dark:bg-sky-900/20 p-3">
                <label className="block text-xs font-semibold text-sky-900 dark:text-sky-100 mb-1">{config?.deploymentKind === 'cloud' ? 'Cloud execution' : 'Runtime — which CLI runs this agent'}</label>
                <select
                  value={runtime}
                ...
                <p className="mt-1 text-xs text-sky-800/80 dark:text-sky-200/70">
                  {config?.deploymentKind === 'cloud' ? 'Cloud agents use model-provider API keys. Local models and CLI tools on your computer are unavailable.' : enabledRuntimes.length > 0
