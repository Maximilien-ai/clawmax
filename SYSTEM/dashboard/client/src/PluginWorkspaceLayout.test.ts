...
assert(pluginPageSource.includes('Number of prompts or repeated experiment samples planned for this Eval.'), 'Eval trial controls must explain what is counted')
...
console.log('PluginWorkspaceLayout.test.ts: 106 tests passed')
