...
assert(pluginPageSource.includes("plugin.objectKind === 'optimization-plan' && viewMode === 'graph'"), 'Optimize graph details must use a non-obstructive inline presentation')
assert(pluginPageSource.includes('selectedItem && !useInlineGraphDetails'), 'Optimize graph selections must not open the standard detail drawer')
