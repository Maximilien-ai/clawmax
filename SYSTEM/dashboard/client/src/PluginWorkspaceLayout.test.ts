...
assert(pluginPageSource.includes('Evaluator guidance'), 'Eval editing must expose judge-specific guidance')
assert(pluginPageSource.includes('Guide the AI evaluator with the rubric'), 'AI evaluator guidance must explain useful rubric content')
...
console.log('PluginWorkspaceLayout.test.ts: 118 tests passed')
