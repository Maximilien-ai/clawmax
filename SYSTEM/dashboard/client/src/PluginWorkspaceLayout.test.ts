...
assert(pluginPageSource.split('<RelationshipZoomControls zoom={zoom} onChange={setZoom} />').length - 1 === 3, 'Guardrails, Evals, and Optimize must all expose relationship zoom')
...
console.log('PluginWorkspaceLayout.test.ts: 142 tests passed')
