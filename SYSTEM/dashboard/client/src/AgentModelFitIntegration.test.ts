...
assert(agentsSource.includes('MODEL_FIT_AUTO_STORAGE_KEY'), 'Auto selection preference must persist across Add and Edit views')
...
console.log('AgentModelFitIntegration.test.ts: 32 tests passed')
